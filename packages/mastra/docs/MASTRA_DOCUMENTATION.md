...
|--------|--------|--------|
| `contentGeneratorAgent` | gemini-2.5-flash | Gera aulas didáticas completas (~2000 palavras) |
| `audioScriptAgent` | gemini-2.5-flash | Adapta texto para narração de áudio |
| `tutorAgent` | gemini-2.5-flash | Mentor virtual que tira dúvidas |
| `editalFullAnalyzerAgent` | gemini-2.5-flash | Analisa PDF do edital e extrai estrutura |
| `editalParserAgent` | gemini-2.5-flash | Parseia texto do edital |
| `materiaPriorityAgent` | gemini-2.5-flash | Sugere ordem de estudo das matérias |
...
| modelo_texto | text | Ex: gemini-2.5-flash |
