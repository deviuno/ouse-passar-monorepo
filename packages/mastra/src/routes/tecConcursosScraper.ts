...
// System prompt para extração de taxonomia
const TAXONOMY_SYSTEM_PROMPT = `Você é um especialista em extrair e estruturar taxonomias de conteúdo educacional.
