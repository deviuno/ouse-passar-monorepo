...
import { Check, Lock, RefreshCw, User, RotateCw, Trophy, GraduationCap, Cpu } from 'lucide-react';
...
import { MassificacaoModal } from './MassificacaoModal';
import { MissionHoverCard } from './MissionHoverCard';
