...
export async function getBatterySettings(): Promise<BatterySettings | null> {
  try {
    ...
    const settings: BatterySettings = {
      ...
      cost_per_chat_audio: parseInt(data.cost_per_chat_audio) || 5,
      cost_per_chat_podcast: parseInt(data.cost_per_chat_podcast) || 10,
      cost_per_chat_summary: parseInt(data.cost_per_chat_summary) || 5,
...
export async function canPerformAction(
  ...
  try {
    ...
    const costMap: Record<BatteryActionType, keyof BatterySettings> = {
      ...
      chat_audio: 'cost_per_chat_audio',
      chat_podcast: 'cost_per_chat_podcast',
      chat_summary: 'cost_per_chat_summary',
